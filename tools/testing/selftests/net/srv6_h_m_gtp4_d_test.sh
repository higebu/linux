...
# (RFC 9433 Figure 10); the template's tail bytes 12..15 are left
# untouched (kept as 0..0..0..1), so the full outer SA below also
# verifies that the ignored tail is not zeroed.
